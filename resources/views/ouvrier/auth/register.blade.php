@extends('ouvrier.layouts.app')

@section('title', 'Inscription Ouvrier')

@section('content')
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">{{ __('Inscription Ouvrier') }}</div>

            <div class="card-body">
                <form method="POST" action="{{ route('ouvrier.register') }}">
                    @csrf
